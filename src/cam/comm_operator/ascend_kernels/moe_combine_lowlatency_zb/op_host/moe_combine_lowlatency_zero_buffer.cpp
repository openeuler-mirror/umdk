...
namespace ops {
class MoeCombineLowlatencyZeroBuffer : public OpDef {
public:
    explicit MoeCombineLowlatencyZeroBuffer(const char *name) : OpDef(name)
    {
        this->Input("expand_x")
            .ParamType(REQUIRED)
...
OP_ADD(MoeCombineLowlatencyZeroBuffer);
