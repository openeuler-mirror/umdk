 ...
 * Description: grouped_matmul_swiglu_quant_v2_layered_a8w4_msd_pipeline header file
 * Create: 2026-09-20
 * Note:
 ...
 * \brief
 */
#ifndef OP_KERNEL_GROUPED_MATMUL_SWIGLU_QUANT_V2_LAYERED_A8W4_MSD_PIPELINE_H
#define OP_KERNEL_GROUPED_MATMUL_SWIGLU_QUANT_V2_LAYERED_A8W4_MSD_PIPELINE_H

#include <typeinfo>
#include "grouped_matmul_swiglu_quant_v2_layered_a8w4_msd_pre.h"
#include "grouped_matmul_swiglu_quant_v2_layered_a8w4_msd_mid.h"
#include "grouped_matmul_swiglu_quant_v2_layered_a8w4_msd_post.h"
...
template <class mmType> class GMMSwigluQuantPipelineSchedule {
  private:
    ...
    // The pre-processing GMMA8W4PreProcess class
    GMMA8W4PreProcess preProcess;
    // The mid-processing GMMA8W4MidProcess class
    GMMA8W4MidProcess<mmType> midProcess;
    // The post-processing GMMA8W4PostProcess class
  ...
  public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR weight, GM_ADDR weightScale, GM_ADDR xScale,
                                GM_ADDR weightAssistanceMatrix, GM_ADDR groupList, int64_t curLayer, GM_ADDR y,
...
__aicore__ inline void GMMSwigluQuantPipelineSchedule<mmType>::Init(GM_ADDR x, GM_ADDR weight, GM_ADDR weightScale,
                                                                    ...
                                                                    GM_ADDR groupList, int64_t curLayer, GM_ADDR y,
                                                                    GM_ADDR yScale, GM_ADDR workspace)
{
    gmAddrParams.xGM = x;
...
template <class mmType> __aicore__ inline void GMMSwigluQuantPipelineSchedule<mmType>::Process()
{
    ...
    // 1. Issue the pre-processing once ahead of time
    ...
    for (int64_t workspaceSplitLoopIdx = 0; workspaceSplitLoopIdx < workspaceSplitConfig.loopCount;
        ...
        SyncAll<false>();
        // 2. The n-th mid-processing, the (n+1)-th pre-processing, and the (n-1)-th post-processing run in parallel
...
#endif // OP_KERNEL_GROUPED_MATMUL_SWIGLU_QUANT_V2_LAYERED_A8W4_MSD_PIPELINE_H