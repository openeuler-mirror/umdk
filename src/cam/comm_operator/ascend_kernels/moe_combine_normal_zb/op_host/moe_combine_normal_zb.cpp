...
namespace ops {
class MoeCombineNormalZb : public OpDef {
public:
    explicit MoeCombineNormalZb(const char *name) : OpDef(name)
    {
        this->Input("recv_x")
            .ParamType(REQUIRED)
        ...
        this->Attr("comm_meta_ptr").AttrType(REQUIRED).Int();
