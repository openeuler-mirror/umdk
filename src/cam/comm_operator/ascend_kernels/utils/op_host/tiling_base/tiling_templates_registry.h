...
class RegisterArch {
  public:
    ...
    template <typename T> RegisterArch &tiling(int32_t priority, int32_t arch)
    {
    ...
    template <typename T> RegisterArch &tiling(int32_t priority, const std::vector<int32_t> &archs)
    {
...
// op_type: operator name, class_name: the registered tiling class, arch: chip architecture number
// priority: priority of the tiling class; a smaller value means higher priority, i.e. this tiling class is selected
// first
...
// op_type: operator name, class_name: the registered tiling class, soc_version: chip version number
// priority: priority of the tiling class; a smaller value means higher priority, i.e. this tiling class is selected
// first
...
// op_type: operator name, class_name: the registered tiling class,
// priority: priority of the tiling class; a smaller value means higher priority, i.e. the greater the probability of
// being selected
...
// op_type: operator name, class_name: the registered tiling class,
// priority: priority of the tiling class; a smaller value means higher priority, i.e. the greater the probability of
// being selected Replaces REGISTER_TILING_TEMPLATE; if the passed op_type is a string constant, its quotes need to be
// removed
