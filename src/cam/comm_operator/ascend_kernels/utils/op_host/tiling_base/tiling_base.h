...
class TilingBaseClass {
  public:
    ...
    //     1. GRAPH_SUCCESS: success, and no need to continue executing the implementations of subsequent Tiling classes
    //     2. GRAPH_FAILED: failure, abort the entire Tiling flow
    //     3. GRAPH_PARAM_INVALID: this class does not support it; continue executing the implementations of other
    //     Tiling classes
