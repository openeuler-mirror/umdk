 ...
 * Create: 2026-08-04
 * Note:
 * History: 2026-08-04 create FusedDeepMoe operator kernel function implementation file
 */
...
extern "C" __global__ __aicore__ void fused_deep_moe(
    ...
    // bias: framework alignment only; unused by arch35 kernel
    GM_ADDR gmm1_bias, GM_ADDR gmm2_bias, GM_ADDR share_gmm1_bias, GM_ADDR share_gmm2_bias,
    // output
    ...
    GM_ADDR workspace, GM_ADDR tiling)
{
    (void)gmm1_bias;
    (void)gmm2_bias;
    (void)share_gmm1_bias;
    (void)share_gmm2_bias;
    icache_preload(8);
