...
#include "aclnnInner_fused_deep_moe_zb.h"
#include "aclnn_fused_deep_moe_zb.h"
...
aclnnStatus aclnnFusedDeepMoeZbGetWorkspaceSize(
    const aclTensor *x,
...
{
    return aclnnInnerFusedDeepMoeZbGetWorkspaceSize(x, expertIds, gmm1Weight, gmm1WeightScale,
...
aclnnStatus aclnnFusedDeepMoeZb(
    void *workspace,
    uint64_t workspaceSize,
    aclOpExecutor *executor,
    aclrtStream stream)
{
    ...
    return aclnnInnerFusedDeepMoeZb(workspace, workspaceSize, executor, stream);
}
