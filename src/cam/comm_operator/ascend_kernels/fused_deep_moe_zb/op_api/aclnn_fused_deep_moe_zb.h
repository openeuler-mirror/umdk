...
#ifndef FUSED_DEEP_MOE_ZB
#define FUSED_DEEP_MOE_ZB
...
__attribute__((visibility("default"))) aclnnStatus aclnnFusedDeepMoeZbGetWorkspaceSize(
    const aclTensor *x,
...
__attribute__((visibility("default"))) aclnnStatus aclnnFusedDeepMoeZb(
    void *workspace,
    uint64_t workspaceSize,
    aclOpExecutor *executor,
    aclrtStream stream);
