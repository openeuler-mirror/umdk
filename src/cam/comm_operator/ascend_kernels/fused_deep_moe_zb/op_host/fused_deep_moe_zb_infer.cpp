 ...
 * Create: 2025-07-22
 * Note:
 * History: 2025-07-13 create FusedDeepMoeZb infer function file
 */
...
static ge::graphStatus InferShape(gert::InferShapeContext *context)
{
    ...
    OPS_ERR_IF(*epRankSizePtr <= 0, OPS_LOG_E(nodeName, "epRankSize must be greater than 0."),
                    return ge::GRAPH_FAILED);
...
IMPL_OP(FusedDeepMoeZb).InferShape(InferShape).InferDataType(InferDataType);
}  // namespace ge
