 ...
 * Description: FusedDeepMoeZb operator definition file
 * Create: 2025-07-19
 * Note:
 * History: 2025-07-19 create FusedDeepMoeZb operator definition file
 */
#include "register/op_def_registry.h"

namespace ops {
class FusedDeepMoeZb : public OpDef {
public:
    explicit FusedDeepMoeZb(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        this->Input("x_active_mask")
            ...
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                                 ...
                                 ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                                 ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND});
        // W4A8: bias/compensation matrix inputs
