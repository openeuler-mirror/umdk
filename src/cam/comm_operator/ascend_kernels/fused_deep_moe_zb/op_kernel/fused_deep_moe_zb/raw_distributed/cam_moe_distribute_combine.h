...
public:
    ...
    __aicore__ inline void Init(GM_ADDR expandX, GM_ADDR expertIds, GM_ADDR expandIdx, GM_ADDR epSendCount,
                                ...
                                GM_ADDR workspaceGM, TPipe *pipe, const FusedDeepMoeZbTilingData *tilingData,
...
__aicore__ inline void CamMoeDistributeCombine<TemplateMC2TypeFunc>::Init(
    ...
    GM_ADDR xActiveMask, GM_ADDR XOut, GM_ADDR workspaceGM, TPipe *pipe, const FusedDeepMoeZbTilingData *tilingData,
