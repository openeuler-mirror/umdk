...
namespace ops {
class MoeDispatchNormalZeroBuffer : public OpDef {
public:
    explicit MoeDispatchNormalZeroBuffer(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        this->Attr("zero_buffer_ptr").AttrType(REQUIRED).Int();
...
OP_ADD(MoeDispatchNormalZeroBuffer);
