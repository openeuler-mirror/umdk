...
struct VectorDataContext
{
    ...
    VectorCoord in_group_problem_shape;
    VectorCoord block_coord;
    VectorCoord actual_block_shape;
    VectorCoord block_offset;
    VectorCoord tile_coord;
    VectorCoord actual_tile_shape;
    VectorCoord tile_offset_in_block;
    VectorCoord tile_offset;
