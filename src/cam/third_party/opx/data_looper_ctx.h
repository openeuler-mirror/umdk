...
struct DataLooperContext
{
    ...
    GemmCoord in_group_problem_shape;
    GemmCoord gmm_block_coord;
    GemmCoord gmm_actual_block_shape;
...
/// @brief DataLooper uses this trait to determine the type of Context required by the specific derived class.
/// @tparam T Derived class type
template <typename T>
struct LooperContextTrait
{
    using Type = DataLooperContext;
};
