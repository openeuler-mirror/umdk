...
static int umq_tp_ub_post(uint64_t umqh_tp, umq_buf_t *qbuf, umq_io_option_t *option, umq_buf_t **bad_qbuf)
{
    return umq_ub_post_impl(umqh_tp, qbuf, option, bad_qbuf);
}

static int umq_tp_ub_poll(uint64_t umqh_tp, umq_io_option_t *option, umq_buf_t **buf, uint32_t max_buf_count)
{
...
static umq_pro_ops_t g_umq_pro_ub_ops = {
    ...
    .umq_tp_interrupt_fd_list_get = umq_tp_ub_interrupt_fd_list_get,
