...
int umq_qbuf_pool_stats_to_str(const umq_qbuf_pool_stats_t *qbuf_pool_stats, char *buf, int max_buf_len)
{
    ...
    UMQ_DFX_SNPRINTF_BUF(buf, max_buf_len, str_size, "%-16s %-9s %-11s %-8s %-8s %-8s %-8s %-8s %-11s %-14s %-14s\n",
    ...
    UMQ_DFX_SNPRINTF_BUF(buf, max_buf_len, str_size, "%s\n",
                         "                                             Expansion Pool");
    UMQ_DFX_SNPRINTF_BUF(buf, max_buf_len, str_size, "%s\n", UMQ_DFX_UNDERLINE_120);
    UMQ_DFX_SNPRINTF_BUF(buf, max_buf_len, str_size, "%-16s %-15s %-17s %-15s %-17s %-17s %-17s\n", "Type", "ExpandCnt",
                         "TotalBlk", "FreeBlk", "MemSize", "AccExpCnt", "AccShrinkCnt");
    UMQ_DFX_SNPRINTF_BUF(buf, max_buf_len, str_size, "%-16s %-15u %-17lu %-15lu %-17lu %-17lu %-17lu\n", "WithData",
