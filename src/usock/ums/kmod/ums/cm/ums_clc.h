...
struct ums_clc_msg_local {            /* header2 of clc messages */
	...
	__be32 clc_session_id; /* CLC session ID generated by ums client */
...
struct umsr_clc_msg_accept_confirm { /* UMSR accept/confirm */
	...
	u8 ub_token_mode : 2; /* 0:secure(out-of-band via ums_agent TLS), 1:legacy(in-band via CLC msg), 2:disable */
	u8 reserved1 : 3;
#elif defined(__LITTLE_ENDIAN_BITFIELD)
	u8 reserved1 : 3;
	u8 ub_token_mode : 2; /* 0:secure(out-of-band via ums_agent TLS), 1:legacy(in-band via CLC msg), 2:disable */
