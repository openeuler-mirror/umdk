	...
	tests := []struct {
	...
	}{
		{
			...
			expected: map[string]uint64{
				...
				"LbNoInstances":                    0,
				"StatAgentRegistered":              0,
				"StatAgentActive":                  0,
				"StatAgentSuspected":               0,
				"StatAgentRecovered":               0,
				"StatAgentGone":                    0,
				"StatAgentUnregistered":            0,
				"StatSessionsActive":               0,
				"StatSessionsSuspended":            0,
				"StatSessionsRecovering":           0,
				"StatSessionsTerminated":           0,
				"StatSessionsEvicted":              0,
				"StatHintsIssuedOffload":           0,
				"StatHintsIssuedPrefetch":          0,
				"StatHintsIssuedEvict":             0,
				"StatHintsAcked":                   0,
				"StatHintsRejected":                0,
				"StatHintsFailed":                  0,
				"StatHintsRetried":                 0,
				"StatHintsPending":                 0,
				"StatBlocksTracked":                0,
				"StatBlocksAttributed":             0,
				"StatBlockMatchMiss":               0,
			},
		},
		{
			name: "withRecords",
